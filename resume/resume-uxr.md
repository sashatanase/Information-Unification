...
## Summary
9 years guided by one principle: explorative research helps build the right thing, iterative
research helps build things right. 9 years leading UX research across complex fintech apps,
DeFi, SSI wallets, and developer tooling. I specialize in qualitative research methodology,
discovery, PMF validation, and behavioral insights. I also build and maintain research ops
processes from the ground up.

## Core Skills
User Research, Research Ops, Developer Experience (DevEx), Product Discovery, PMF Validation,
Jobs-to-be-Done Analysis, Qualitative & Quantitative Methods, User Segmentation, Behavioral
Analysis, Insight Synthesis, Usability Testing, Diary Studies, Stakeholder Alignment, Research
Repository Management, AI-assisted Research Workflows
...
- Organized Discovery Workshops in the early stages of product development to help the Product Team shape future features and products.
...
- Conducted User Research Interviews across both explorative and generative phases, using qualitative and quantitative methods.
- Organized UX Workshops to align stakeholders and define problems to solve.
- Led the experience, architecture, and interaction design for several of the company's tool flows and digital services, from incipient phase to launch-ready.
...
- [Elevating Developer Experience (DX) in web3 — a framework](https://www.youtube.com/watch?v=ZPoqwAbMWTE) — EthCC[6] Paris, 2023 (with Daniel Luca)
- [The Future of Web3UX — a Paradigm Shift for Better Collaboration between Design and Development](https://www.youtube.com/watch?v=gOiHwmL0VUg) — DevCon VI Bogota, 2022
- [Accessibility: Ethereum for LITERALLY everyone!](https://www.youtube.com/watch?v=c24eAsxi3ZM) — EthCC[4] Paris, 2022
- [That never even crossed my mind! How to spot & fix your cognitive biases](https://www.youtube.com/watch?v=O7ygnEtReDs) — EthCC[3] Paris, 2020
- [User Research: How to Get Out of Our Bubbles by Talking to Users](https://www.youtube.com/watch?v=52SP-Upd4es) — DevCon V Osaka, 2019 (with Georgia Rakusen)
