...
- Designing for Trust in Web3: Lessons from the User Research Field — EthCC[7] Cannes, 2025
- Elevating Developer Experience (DX) in web3 — a framework — EthCC[6] Paris, 2023 (with Daniel Luca)
- The Future of Web3UX — a Paradigm Shift for Better Collaboration between Design and Development — DevCon VI Bogota, 2022
- Accessibility: Ethereum for LITERALLY everyone! — EthCC[4] Paris, 2022
